...
const DiscardPoints = () => {
    ...
    return (
        ...
        <Container $width="100%" $height="100%" $justify="space-between" $padding="0.5rem" $resposive={{ $direction: "column", $padding: "0.5rem", $gap: "0.5rem", $justify: "space-between", $width: "100vw" }}>
            ...
            <Container $width="25%" $height="89vh" $border="2px solid #008000" $direction="column" $padding="0.5rem" $justify="flex-start" $align="center" $overflowY='auto' $radius="0.5rem" $resposive={{ $width: "100vw", $direction: "row", $overflowX: "auto", $overflowY: "none", $padding: "0.5rem", $gap: "0.5rem", $justify: "flex-start", $align: "center" }}> 
